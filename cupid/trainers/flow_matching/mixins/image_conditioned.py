...
class ImageConditionedMixin:
    ...
    def prepare_for_training(image_cond_model: str, **kwargs):
        ...
        # download the model
        torch.hub.load('facebookresearch/dinov2:main', image_cond_model, pretrained=True)
    ...
    def _init_image_cond_model(self):
        ...
        with dist_utils.local_master_first():
            dinov2_model = torch.hub.load('facebookresearch/dinov2:main', self.image_cond_model_name, pretrained=True)
