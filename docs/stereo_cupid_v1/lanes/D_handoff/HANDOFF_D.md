...
为响应该首错，`316398`（server03，COMPLETED `0:0`，00:01:13）生成了 per-asset mapping receipt，但只能生成内容哈希绑定的 `UNVERIFIED_EXTERNAL_EVIDENCE`：`/public/home/ricky/RESULTS/STEREO_CUPID_D_MAPPING_RECEIPT_A1/canonical_frame_mapping_receipt.json`，SHA256 `3a59c2fcf2dbf3c4c80970ad0d2d2c1b91ff58e49d39eda6d47731a7ddb15fe3`。`source_asset_sha256` 与 renderer/importer SHA 已绑定，`canonical_frame`、axis map、scale/offset 仍为 null；因此新 receipt `/public/home/ricky/RESULTS/STEREO_CUPID_D_MAPPING_RECEIPT_A1/EXTERNAL_BLOCKER_RECEIPT.json`（SHA256 `96e107167dc1b107dab2b421cb2b17b0e4496f66e4536700822013ce7b4e3939`）首个失败仍为 `canonical_to_frame_mapping`，没有伪造修复，也没有生成 occupancy/target。
