...
CUPID_NVDIFFRAST_OVERLAY="${CUPID_NVDIFFRAST_OVERLAY:-/public/home/ricky/ENVIRONMENT/cupid_nvdiffrast_253ac4f_py312_v20r1}"
...
CUPID_MASTER_PORT="${CUPID_MASTER_PORT:-$((10000 + SLURM_JOB_ID % 50000))}"
...
print("CUPID_DDP_IMPORT_GATE=PASS")
PY
